...
export class AppComponent implements OnInit {
  ...
  addresses = ["koramangala","marathahalli","forum%20mall","indiranagar%20banglore","mahadeveapura%20banglore"]
  jsonresponse;
  allcoordinates;
  points=[]
  coordinates=[];
          ...
          this.zone.run(()=>
            {
              ...
              setMapCenter(mapp,this.coordinates)
      ...
      function setMapCenter(map,coordinates)
        {
          ...
          map.center=[coordinates[0][1],coordinates[0][0]]
        }
    }
